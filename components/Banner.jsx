    ...
    return (
        <div className="overflow-hidden md:px-4 mobile:px-[2px] ">
            <div className=" relative flex flex-col justify-center items-center  " style={{ height: '140px' }}>
                ...
                <div className="absolute w-full flex flex-col mb-[0px] mobileL:mb-[0px] middle:mb-[8px]  justify-center mobile:px-1 items-center mobile:gap-[.8rem] md:gap-10 lg:gap-8 2xl:gap-10">
