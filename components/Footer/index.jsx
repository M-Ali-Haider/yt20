...
const Footer = () => {
    return (
        <footer className="mt-[40px] px-[20px]  sm:px-20 py-16 w-full flex flex-col filterBarDim:flex-row flex-wrap justify-between gap-14 border-t-2 border-[#FFFFFF4D]">
